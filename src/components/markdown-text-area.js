...
import ToolbarController from './markdown-text-area_toolbar_controller';
  ...
  renderToolbar() {
    ...
    return (
      <div className={this.props.classNames.toolbar}>
        <button
          onClick={this.enableWrite}
          className={
            this.state.writing
              ? this.props.classNames.actionWriteActive
              : this.props.classNames.actionWrite
          }
        >
        ...
        <button
          ...
          className={
            this.state.writing
              ? this.props.classNames.actionPreview
              : this.props.classNames.actionPreviewActive
          }
        >
        ...
        {this.props.help && (
          <a
            className={this.props.classNames.help}
            href={this.props.help.link}
            target="_blank"
  ...
  render() {
    ...
    return (
      <div
        ...
        className={
          isActive
            ? this.props.classNames.moduleActive
            : this.props.classNames.module
        }
      >
        ...
        {!this.state.writing && (
          <div
            className={this.props.classNames.preview}
            dangerouslySetInnerHTML={{
              __html: this.props.render(this.state.value),
            }}
            style={{ minHeight }}
          />
        )}
...
export { insert, actions, help, classNames };
